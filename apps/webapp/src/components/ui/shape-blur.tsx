/**
 * Shape Blur – animated border blur effect (hover).
 * Adapted from React Bits https://reactbits.dev/animations/shape-blur
 * Uses Three.js for the shader effect. No extra package required (three is already installed).
 */

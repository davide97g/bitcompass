    ...
    <div className="relative min-h-screen flex items-center justify-center p-4">
      ...
      >
        <div className="relative z-10 w-full max-w-md animate-fade-in">
          {/* Soft panel: card sized to content so transparent PixelCard aligns with form */}
          <div className="relative w-full rounded-2xl border border-border bg-background/95 shadow-xl backdrop-blur-sm">
            <PixelCard variant="pink" className="relative inset-0 !w-full !h-full rounded-2xl overflow-hidden" >
              <div className="absolute inset-0 z-10 flex flex-col p-8 pt-10 pb-10">
                {/* Logo and Title */}

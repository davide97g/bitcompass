  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* Rules & solutions kind colorization (frontend-only) */
        ...
        "tag-orange-text": "hsl(var(--tag-orange-text))",
        "tag-gold": "hsl(var(--tag-gold))",
        "tag-gold-text": "hsl(var(--tag-gold-text))",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "glow-pulse": {
          ...
          "50%": { boxShadow: "0 0 40px -5px var(--glow-color)" },
        },
      },
      animation: {
